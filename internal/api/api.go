...
import (
	...
	"github.com/maiconloure/go-react-server/internal/store/pgstore"
...
func (h apiHandler) handleCreateRoom(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		http.Error(w, "failed to insert room", http.StatusInternalServerError)
		return
	}
	...
	data, _ := json.Marshal(response{ID: roomID})
...
func (h apiHandler) handleCreateRoomMessage(w http.ResponseWriter, r *http.Request) {
	...
	data, _ := json.Marshal(response{ID: messageID})
	w.Header().Set("Content-Type", "application/json")
	_, _ = w.Write(data)
